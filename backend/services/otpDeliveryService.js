...
const shouldExposeDevOtp = () => {
  ...
  return !isProduction && (OTP_PROVIDER === 'mock' || explicitlyEnabled);
};
...
const getProviderHealth = () => {
  ...
  return {
    ...
    ready: true,
    details: {
      note: 'Mock provider active. OTPs are logged locally and can be exposed in non-production if enabled.',
    },
  };
};
